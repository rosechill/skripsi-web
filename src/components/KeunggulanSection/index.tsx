...
export default function index() {
  return (
    <section className="lg:flex bg-[#FCFCFC] py-[10vh]">
      <div className="flex lg:flex-row flex-col lg:mx-24 mx-8 lg:gap-24 gap-8">
        <div className="flex flex-col justify-center lg:items-center text-center  relative  gap-8 ">
          <h1 className='text-[#2E3E78] lg:text-4xl text-2xl font-bold '>Keunggulan</h1>
          <p className="text-[#2E3E78]  lg:text-center text-justify">
